  ...
  createWidgetElements() {
    ...
    disclaimerContainer.innerHTML = `
      <div class="footer-content">
        <img class="footer-logo" src="logo-no-bg.png" alt="Aura Logo" style="cursor:pointer; margin-right: 10px; height: 36px; max-height: 36px; width: auto; float: left; display: inline-block;" />
